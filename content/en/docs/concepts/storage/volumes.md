...
* there is a [limit](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-volumes-multi.html) to the number of EC2 instances that can be attached to an EBS volume
